...
TemplateManager.templates.userSelection = `
    ...
    <div id='user-selection-results' class='background-color-white border-light-gray hidden'></div>
`;
...
TemplateManager.templates.tagSelection = `
    ...
    <div id='tag-selection-results' class='background-color-white border-light-gray hidden'></div>
`;
...
TemplateManager.templates.boardTask = `
    <div>
        <div class='board-task-priority background-color-priority-<%- priority %> font-white font-very-small font-white sides-round text-center-horizontal'><%- priorityString %></div>
...
TemplateManager.templates.dueDateAssigned = `
    <%- dueDateStringShort %>
`;
...
TemplateManager.templates.projectDetails = `
    ...
    <div id='project-details-scroll-container' class='flex-column flex-grow overflow-y-scroll'>
...
TemplateManager.templates.taskDetails = `
    ...
    <div id='task-details-scroll-container' class='flex-grow overflow-y-scroll background-color-light-gray'>
    ...
    <div id='task-details-new-comment' class='flex-fit-content'>
...
TemplateManager.templates.taskDetailsPriority = `
    <div id='task-details-priority-text' class='background-color-priority-<%- priority %> font-white font-small font-white sides-round text-center-horizontal'><%- priorityString %></div>
    <div class='remove-button-small background-color-light-gray child-center circle hover-background-color-dark-gray invisible'>
        <div class='font-very-small font-white'>X</div>
    </div>
`;
